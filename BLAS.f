c     The routines on this file are public-code Basic Linear Algebra 
c     Subroutines (BLAS) used by various public-code routines for
c     matrix inversion, matrix eigenanlysis, etc
c
